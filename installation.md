...
<div style="margin-top: 2rem; display: flex; gap: 1rem; flex-wrap: wrap;">
  ...
  <a href="contact.html" style="display: inline-block; padding: 0.75rem 1.5rem; background: linear-gradient(135deg, #5c23fb 0%, #55576c 100%); color: white; text-decoration: none; border-radius: 8px; font-weight: 600; box-shadow: 0 4px 6px rgba(0,0,0,0.1); transition: transform 0.2s, box-shadow 0.2s;">Contact Us</a>
</div>
